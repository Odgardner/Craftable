# All items available in the game. Order here is the order the palette
# ("Inventory") renders in, grouped by category — 18 items = a clean
# 9-wide x 2-row grid with no leftover space.
ITEMS = {
    "air":        {"name": "Empty",        "abbr": "",      "bg": "#1a1a2e", "fg": "#555",    "border": "#2a2a3e"},

    # Blocks
    "oak_planks": {"name": "Oak Planks",   "abbr": "OAK",   "bg": "#7a5c2e", "fg": "#f0d090", "border": "#5a3c1e"},
    "cobble":     {"name": "Cobblestone",  "abbr": "COBB",  "bg": "#5a5a5a", "fg": "#e0e0e0", "border": "#3a3a3a"},
    "stone":      {"name": "Stone",        "abbr": "STNE",  "bg": "#8a8a8a", "fg": "#f0f0f0", "border": "#6a6a6a"},
    "sand":       {"name": "Sand",         "abbr": "SAND",  "bg": "#c8b870", "fg": "#5a4820", "border": "#9a8a48"},
    "wool":       {"name": "Wool",         "abbr": "WOOL",  "bg": "#e0e0e0", "fg": "#444",    "border": "#bbb"},

    # Ores & Ingots
    "iron":       {"name": "Iron Ingot",   "abbr": "IRON",  "bg": "#b0b0b0", "fg": "#222",    "border": "#808080"},
    "gold":       {"name": "Gold Ingot",   "abbr": "GOLD",  "bg": "#d4a000", "fg": "#fff8e0", "border": "#a07800"},
    "diamond":    {"name": "Diamond",      "abbr": "DIAM",  "bg": "#00bcd4", "fg": "#e0ffff", "border": "#008fa1"},
    "redstone":   {"name": "Redstone",     "abbr": "RDST",  "bg": "#a00000", "fg": "#ffaaaa", "border": "#600000"},
    "coal":       {"name": "Coal",         "abbr": "COAL",  "bg": "#1e1e1e", "fg": "#aaa",    "border": "#111"},
    "quartz":     {"name": "Nether Quartz","abbr": "QRTZ",  "bg": "#e8e0d8", "fg": "#3a3430", "border": "#c0b8ac"},

    # Mob Drops
    "leather":    {"name": "Leather",      "abbr": "LETH",  "bg": "#6b3410", "fg": "#d4905a", "border": "#3a1a06"},
    "feather":    {"name": "Feather",      "abbr": "FETH",  "bg": "#e8e8d8", "fg": "#444",    "border": "#bbb"},
    "string":     {"name": "String",       "abbr": "STRG",  "bg": "#d8d8d8", "fg": "#333",    "border": "#aaa"},
    "gunpowder":  {"name": "Gunpowder",    "abbr": "GNPW",  "bg": "#4a4650", "fg": "#d8d0e0", "border": "#2a2830"},

    # Materials
    "stick":      {"name": "Stick",        "abbr": "STCK",  "bg": "#4a2e10", "fg": "#c09060", "border": "#2a1a08"},
    "wheat":      {"name": "Wheat",        "abbr": "WHET",  "bg": "#c8a020", "fg": "#fff5cc", "border": "#906800"},
    "flint":      {"name": "Flint",        "abbr": "FLNT",  "bg": "#3a3050", "fg": "#b0a8d0", "border": "#1e1a30"},
}

# Each grid is 9 slots: row-major order (left-to-right, top-to-bottom)
...
# show one of them). Fail loudly at import time instead of silently
# shipping a broken puzzle.
_seen_grids = {}
for _r in RECIPES:
    _key = tuple(_r["grid"])
    if _key in _seen_grids:
        raise ValueError(
            f"Duplicate recipe grid: {_seen_grids[_key]!r} and {_r['result']!r} "
            f"craft from the exact same 3x3 layout."
        )
    _seen_grids[_key] = _r["result"]
